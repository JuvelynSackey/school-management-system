...
router.get('/receipt/:schoolSlug/:id', controller.verifyReceipt);
router.get('/report/:schoolSlug/:id', controller.verifyReport);
router.get('/student/:schoolSlug/:id', controller.verifyStudent);
