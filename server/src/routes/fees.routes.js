...
router.get('/arrears-summary', authorize('admin'), controller.arrearsSummary);
router.get('/', authorize('admin', 'parent'), controller.list);
...
router.get('/:id/payments', authorize('admin', 'student', 'parent'), controller.getPayments);
router.post('/:id/payments', authorize('admin'), paymentValidator, validate, controller.recordPayment);
router.get('/:feeId/payments/:paymentId/receipt', authorize('admin', 'student', 'parent'), controller.downloadReceipt);
