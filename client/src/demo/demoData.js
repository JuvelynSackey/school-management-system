...
// fetched from the real API — client/src/pages/demo/** and
// client/src/components/demo/** must never import from client/src/api/*.
// This module is the ONLY source of data for the whole sandbox.
