...
export const NAV_ITEMS = [
  ...
  { to: '/assessments', label: 'Assessments', roles: ['admin', 'teacher', 'student'], group: 'ACADEMICS', icon: 'assessment' },
  ...
  { to: '/feeding-charges', label: 'Feeding Charges', roles: ['admin'], group: 'FINANCE', icon: 'feedingCharges' },
